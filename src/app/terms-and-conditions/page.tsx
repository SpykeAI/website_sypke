      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 relative z-20">
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden p-8 md:p-16">
          ...
          ">
            ...
            <p><strong>If you do not agree with these Terms, you should not access or use our Services.</strong></p>
            ...
            <p>AI Systems may occasionally generate incorrect, incomplete, outdated, unexpected, or inappropriate outputs.</p>
            ...
            <p>The availability and functionality of certain Services may therefore depend on third-party systems.</p>
            <p>SpykeAI does not control third-party services and cannot guarantee their availability, performance, pricing, policies, security, or continued operation.</p>
            ...
            <p>Where required, the parties may enter into additional data-processing terms or agreements.</p>
            ...
            <p>The Client may terminate Services in accordance with the cancellation or termination terms contained in the applicable commercial agreement.</p>
