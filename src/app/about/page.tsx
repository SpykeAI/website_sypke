...
export default function About() {
  return (
    <div className="min-h-screen bg-white font-sans">
      {/* Header */}
      <section className="bg-gray-50 text-gray-900 py-24 px-4 sm:px-6 lg:px-8 border-b border-gray-200">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl font-bold mb-6 text-gray-900 font-heading">Turning AI Into Real Business Outcomes</h2>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <div className="space-y-4 text-lg text-gray-600 leading-relaxed">
              <p><strong className="text-gray-900">Spyke AI Technologies was founded on a simple observation:</strong></p>
              ...
              <p>Yet for a business owner, the real question isn't: <em className="text-gray-900 font-bold">"Which AI tool should I use?"</em></p>
          ...
          <div className="bg-white p-10 rounded-3xl border border-gray-200 shadow-2xl">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 font-heading">Built by a Product Leader</h2>
            <div className="space-y-4 text-lg text-gray-600 leading-relaxed">
              ...
              <div className="bg-gray-50 p-6 rounded-2xl border-l-4 border-[#00DF81] mt-6">
                <p className="italic text-gray-600">"We don't start with: 'Here's a cool AI tool. Let's find something to do with it.' We start with: <strong>'What problem are we trying to solve, and where can AI create the most leverage?'</strong> Then we work backwards to build the solution."</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-gray-50 px-4 sm:px-6 lg:px-8 border-y border-gray-200">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 font-heading">Our Mission</h2>
          <h3 className="text-2xl font-bold text-[#00DF81] mb-6">Make AI Practical for Every Business</h3>
          <p className="text-xl text-gray-600 mb-8 font-bold p-8 bg-white rounded-2xl border border-gray-200">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4 font-heading">What We Do</h2>
            <p className="text-xl text-gray-600">SpykeAI provides AI-powered services and implementation solutions for businesses.</p>
          </div>
      ...
      <section className="py-24 bg-gray-50 px-4 sm:px-6 lg:px-8 border-y border-gray-200">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4 font-heading">Our Approach</h2>
            <p className="text-xl text-gray-600">We believe successful AI implementation is less about the technology and more about solving the right problem.</p>
          </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            <h2 className="text-4xl font-bold text-gray-900 mb-8 font-heading">Why SpykeAI?</h2>
            <ul className="space-y-6">
              <li className="bg-white p-6 rounded-2xl border border-gray-200">
                <h4 className="text-xl font-bold text-gray-900 mb-2 font-heading">We Start With the Business Problem</h4>
                <p className="text-gray-600">We don't believe in adding AI simply because AI is fashionable. We first identify the problem and then determine whether AI is the right solution.</p>
              </li>
              <li className="bg-white p-6 rounded-2xl border border-gray-200">
                <h4 className="text-xl font-bold text-gray-900 mb-2 font-heading">Product Thinking, Not Just Tool Integration</h4>
                <p className="text-gray-600">Our product background means we think beyond connecting APIs. We look at the complete experience, business logic, edge cases, and measurable outcomes.</p>
              </li>
              <li className="bg-white p-6 rounded-2xl border border-gray-200">
                <h4 className="text-xl font-bold text-gray-900 mb-2 font-heading">Built Around Your Existing Stack</h4>
                <p className="text-gray-600">Your business already has tools, systems, and CRMs. Where possible, we integrate AI into that ecosystem rather than forcing you to replace everything.</p>
              </li>
              <li className="bg-white p-6 rounded-2xl border border-gray-200">
                <h4 className="text-xl font-bold text-gray-900 mb-2 font-heading">Human + AI</h4>
                <p className="text-gray-600">We don't believe every business process should become fully autonomous. The right balance between AI automation and human oversight depends on the use case.</p>
              </li>
            </ul>
          </div>

          <div>
            <h2 className="text-4xl font-bold text-gray-900 mb-8 font-heading">Who We Work With</h2>
            <p className="text-lg text-gray-600 mb-6">Our solutions can be applied across industries including:</p>
            ...
            <div className="bg-gray-50 p-8 rounded-3xl border border-[#00DF81]/30 mt-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-4 font-heading">Our Vision</h3>
              <p className="text-gray-600 mb-4">We believe the next generation of businesses will not simply use AI tools. <strong>They will be AI-powered businesses.</strong></p>
      ...
      <section className="bg-[#00DF81] text-black py-20 px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <a href="http://wa.link/18sxk1" target="_blank" rel="noreferrer" className="inline-block bg-white text-gray-900 px-10 py-5 rounded-full font-bold text-xl hover:bg-gray-900 transition shadow-2xl">
...
function ServiceCard({ title, description }: { title: string, description: string }) {
  return (
    <div className="bg-white p-8 rounded-2xl border border-gray-200 hover:border-[#00DF81]/50 transition group">
      <h3 className="text-2xl font-bold text-gray-900 mb-4 font-heading group-hover:text-[#00DF81] transition">{title}</h3>
...
function StepCard({ step, title, desc }: { step: string, title: string, desc: string }) {
  return (
    <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200 flex flex-col">
